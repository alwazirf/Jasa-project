...
class MemberDataCreate extends Component
{
    use WithFileUploads;
    public $name;
    public $gender;
    ...
    public function store()
    {
        ...
        $member = Member::create([
            ...
            'member_no' => 20151216 . str_pad(auth()->user()->city->id, 2, '0', STR_PAD_LEFT) . str_pad($id_member + 1, 5, '0', STR_PAD_LEFT),
            'name' => $this->name,
            'gender' => $this->gender,
    ...
    {
        return view('livewire.laravel-examples.sub-admin.member-data-create');
    }
}
