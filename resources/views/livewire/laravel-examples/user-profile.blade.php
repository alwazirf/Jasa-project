            ...
            <div class="card-body pt-4 p-3">
                ...
                <form wire:submit.prevent="save" action="#" method="POST" role="form text-left">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user.city" class="form-control-label">{{ __('Kabupaten') }}</label>
                                <select wire:model="user.city_id" name="city_id" class="form-select @error('city_id') is-invalid @enderror" aria-label="Default select example" required>
                                    @foreach ($cities as $city)
                                    <option value="{{ $city->id }}">{{ $city->name }}</option>
                                    @endforeach
                                </select>
                                @error('user.city_id') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user.level" class="form-control-label">{{ __('Level') }}</label>
                                <select wire:model="user.level_id" name="level_id" class="form-select @error('level_id') is-invalid @enderror" aria-label="Default select example" required>
