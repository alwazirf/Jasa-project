                ...
                <div class="card-header pb-0">
                    ...
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="col-md-6">
                                <div class="input-group">
                                    <select wire:model="searchkab" name="city" class="form-select @error('city') is-invalid @enderror" aria-label="Default select example" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="/create-member" class="btn bg-gradient-primary btn-sm mb-0" type="button">+Member</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('member-show', ['id' => $member->id]) }}" class="mx-2" data-bs-toggle="tooltip"
                                            data-bs-original-title="Lihat Data">
                                            <i class="fas fa-eye text-secondary"></i>
                                    </a>
                                        <a href="{{ route('member-edit', ['id' => $member->id]) }}" class="mx-2" data-bs-toggle="tooltip"
