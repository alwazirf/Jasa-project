        ...
        <div class="card-body pt-4 p-3">
            <form wire:submit.prevent="store" action="#" method="POST" role="form text-left">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="image" class="form-label @error('image') is-invalid @enderror">{{ __('Photo') }}</label>
                            <img src="" class="img-preview img-fluid mb-3 col-sm-5">
                            <input wire:model="image" class="form-control" type="file" id="image" name="image" onchange="previewImage()">
                            @error('image')
