<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('dashboard') }}">
            <img src="assets/img/logos/jasa.png" class="navbar-brand-img h-100" alt="...">
            <span class="ms-1 font-weight-bold">J A S A</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Anggota</h6>
            </li>
            @can('notadmin')
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'member-data' ? 'active' : '' }}"
                    href="{{ route('member-data') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['member-data']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
            ...
            @can('admin')
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'member-management' ? 'active' : '' }}"
                    href="{{ route('member-management') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['member-management']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">Data Anggota</span>
                </a>
            </li>
            ...
            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Cetak Data</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'card' ? 'active' : '' }}"
                    href="{{ route('card') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Kartu Anggota</span>
                </a>
            </li>
            @endcan
            <li class="nav-item">
